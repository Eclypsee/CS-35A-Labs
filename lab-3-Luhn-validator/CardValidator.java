...
public class CardValidator {
    ...
    public static void main(String[] args) {
        ...
        int i=1;
        while (i<=5) {//change 5 to the number of test runs you want
            Scanner sc = new Scanner(System.in);
            System.out.print("test run: " + i + " Insert your credit card as a long number: ");
            if (sc.hasNextLong()) {
                long number = sc.nextLong();
                boolean isBetweenThirteenAndSixteenValid = betweenThirteenAndSixteen(number);
                if (!isBetweenThirteenAndSixteenValid) {
                ...
                System.out.println("your input is not a pure-blood number");
        }
